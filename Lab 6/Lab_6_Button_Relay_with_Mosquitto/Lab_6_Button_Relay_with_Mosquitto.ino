...
#define WLAN_PASS       "***YOUR PASSWORD HERE***"    // Specify the password for your wifi

/************************* Adafruit.io Setup *********************************/

#define AIO_SERVER      "io.adafruit.com"       // Pulling data from the Adafruit website
#define AIO_SERVERPORT  1883                    // use 8883 for SSL
#define AIO_USERNAME    "***YOUR ADAFRUIT NAME***" // Username for Adafruit (goes before the /feed/# MQTT feed)
#define AIO_KEY         "***YOUR ADAFRUIT KEY***"  // Obtained by going to io.adafruit.com and clicking AIO Key link in top right. Copy the "Active Key" here

/************************* Mosquitto MQTT Setup ******************************/

const char* mqttServer = "192.168.137.1";       // The location of your local MQTT Server
...
void setup() {                      // This runs when the board is first turned on
  Serial.begin(115200);             // This allows serial information when connected to a computer (in here, this shows MQTT passed information)
...
void loop() {                       // This constantly cycles through, ensuring both MQTT servers are connected and watching if information comes across Adafruit.io
